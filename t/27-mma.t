...
MIDIText MMA input generated by Data::iRealPro::Output::MMA version $Data::iRealPro::VERSION
...
TODO: {
    local $TODO = "Repeat endings need fix";
    isnt($res[62], "RepeatEnd");
    if ( $res[62] eq "RepeatEnd" ) {
	splice( @res, 62, 2, "RepeatEnd" );
    }
}
